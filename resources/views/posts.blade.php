...
<div class="card mb-3">
    @if ($posts[0]->image)
        ...
        <div class="card-body text-center">
            ...
            <a href="/posts/{{ $posts[0]->slug }}" class="text-decoration-none btn btn-primary">Lihat selengkap nya</a>
        ...
        <div class="col-md-4 mb-3">
            ...
            @endif
                ...
                <div class="card-body">
                    ...
                    <a href="/posts/{{ $post->slug }}" class="btn btn-primary">Gw da Muak</a>
                </div>
            </div>
        </div>
        @endforeach
...
{{ $posts->links() }}
    ...
    {{-- @foreach ($posts->skip(1) as $post)
        ...
        <a href="/posts/{{ $post->slug }}" class="text-decoration-none">Lihat selengkap nya ....</a>
        </article>
    @endforeach --}}
