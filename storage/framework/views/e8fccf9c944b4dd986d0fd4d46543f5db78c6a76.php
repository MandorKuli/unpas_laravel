...
<div class="card mb-3">
    <?php if($posts[0]->image): ?>
            <div style="max-height: 580px; overflow:hidden;">
                <img src="<?php echo e(asset('storage/'. $posts[0]->image)); ?>" alt="<?php echo e($posts[0]->category->name); ?>" class="img-fluid card-img-top">
            </div>
                <?php else: ?>
        ...
        <div class="card-body text-center">
            ...
            <a href="/posts/<?php echo e($posts[0]->slug); ?>" class="text-decoration-none btn btn-primary">Lihat selengkap nya</a>
...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
            <div class="position-absolute px-3 py-2 text-white" style="background-color: rgba(0, 0, 0, 0.7)"><a href="/posts?category=<?php echo e($post->category->slug); ?>" class="text-decoration-none text-white"><?php echo e($post->category->name); ?></a></div>
            ...
            <?php endif; ?>
                ...
                <div class="card-body">
                    ...
                    <a href="/posts/<?php echo e($post->slug); ?>" class="btn btn-primary">Gw da Muak</a>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\application2\coba-laravel\resources\views/posts.blade.php ENDPATH**/ ?>