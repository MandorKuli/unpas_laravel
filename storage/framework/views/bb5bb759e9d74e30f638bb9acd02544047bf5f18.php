<nav class="navbar navbar-expand-lg navbar-dark bg-danger">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        ...
        <ul class="navbar-nav ms-auto">
          ...
          <?php else: ?>
          <li class="nav-item">
            <a href="/login" class="nav-link <?php echo e(($active === "login") ? 'active' : ''); ?>"><i class="bi bi-box-arrow-right"></i>Login</a>
          </li>
          <?php endif; ?>
        </ul>      
  ...
  </nav><?php /**PATH C:\application2\coba-laravel\resources\views/partials/navbar.blade.php ENDPATH**/ ?>